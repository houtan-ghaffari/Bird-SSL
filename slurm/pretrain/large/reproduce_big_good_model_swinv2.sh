...
#SBATCH --job-name=birdMAE_XCL_large_nomix_reproduce_swinv2
#SBATCH --output=/mnt/work/bird2vec/logs/without_siwn/birdMAE_XCL_large_%N_%t_nomix_reproduce_swinv2.log
...
srun python train_ssl.py \
        ...
        module.network.decoder.mode=swinv2 \
