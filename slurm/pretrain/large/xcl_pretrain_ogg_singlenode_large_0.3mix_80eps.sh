...
#SBATCH --job-name=birdMAE_XCL_large_0.7mix_80eps
#SBATCH --output=/mnt/work/bird2vec/logs/without_siwn/birdMAE_XCL_large_%N_%t_0.7mix_80eps.log
...
srun python train_ssl.py \
        ...
        data.transform.waveform_augmentations.mixup_wave.p=0.7 \
